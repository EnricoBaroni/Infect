...
> **Reference document — not an implementation roadmap.**
> This matrix classifies the Isaac passive mechanic design space by reusable family. It exists to prevent accidental duplication and to identify coverage gaps. It does **not** define autonomous implementation priority. For the current milestone and next steps, see `docs/implementation/AGENT_CONTEXT.md` Section 8.
>
> Coverage status is updated manually. Verify against the actual `items/effects/` directory when status is uncertain.
...
| M002 | Multiplicative stat scaler | Stat effect | Gameplay mechanic | Rebirth | Implemented |
| M003 | Conditional stat bonus (state-gated) | Trigger effect | Stat effect, Gameplay mechanic | Rebirth | Planned |
| M004 | Temporary timed stat buff | Trigger effect | Stat effect, Gameplay mechanic | Rebirth | Implemented |
| M005 | On-damage stat ramp | Trigger effect | Stat effect | Rebirth | Implemented |
| M006 | On-kill stat ramp | Trigger effect | Stat effect | Rebirth | Implemented |
...
| M020 | Charged release tiers | Weapon mechanic | Trigger effect | Rebirth | Implemented |
...
| M043 | Temporary ally spawn on damage taken | Spawn effect | Companion effect, Trigger effect | Rebirth/AB | Implemented |
| M044 | Temporary ally spawn on kill | Spawn effect | Companion effect, Trigger effect | AB | Implemented |
| M045 | Kill-generated blue flies/spiders locusts | Spawn effect | Death effect, Trigger effect | Rebirth | Planned |
| M046 | Projectile-on-hit extra spawn | Spawn effect | Trigger effect, Projectile mechanic | AB/Rep | Implemented |
| M047 | Room-entry hazard proc (mass status pulse) | Room effect | Status effect, Trigger effect, Luck interaction | AB/Rep | Implemented |
...
| M055 | Shop price multiplier reduction | Shop effect | Economy effect | Rebirth | Implemented |
| M056 | Shop free purchase tokenization | Shop effect | Economy effect, Trigger effect | Rebirth | Planned |
| M057 | Shop restock behavior modification | Shop effect | Economy effect, Trigger effect | AB | Implemented |
...
| M068 | Status infliction: charm | Status effect | Projectile mechanic, Trigger effect | Rebirth | Implemented |
| M069 | Status infliction: confusion | Status effect | Projectile mechanic, Trigger effect | Rebirth | Implemented |
| M070 | Status infliction: petrify/freeze hard-CC | Status effect | Death effect, Projectile mechanic, Luck interaction | Rebirth/Rep | Implemented |
| M071 | Status infliction: bleed | Status effect | Projectile mechanic, Trigger effect | AB | Implemented |
| M072 | Status infliction: bait/mark | Status effect | Projectile mechanic, Trigger effect | Rep | Implemented |
| M073 | Status infliction: chained/root | Status effect | Trigger effect | Rep | Implemented |
...
| M079 | Room-wide pulse on event (damage/kill/entry) | Room effect | Trigger effect, Status effect | Rebirth/AB | Implemented |
| M080 | Room curse removal or suppression | Curse effect | Room effect, Trigger effect | Rebirth/Rep | Planned |
| M081 | Room reveal/map intelligence | Room effect | Economy effect, Special mechanic | Rebirth | Implemented |
...
| M085 | Luck stat direct up/down | Luck interaction | Stat effect | Rebirth | Implemented |
| M086 | Luck-scaled proc curves (linear/exponential/capped) | Luck interaction | Trigger effect, Status effect | Rebirth | Implemented |
...
| M089 | Damage prevention layers (shields/mantles/procs) | Special mechanic | Trigger effect, Aura effect | Rebirth | Implemented |
...
Last updated: August 2026. Verify against `items/effects/` and `AGENT_CONTEXT.md` Section 7 for ground truth.

Implemented families:
- Stat ops: M001, M002, M004, M005, M006
- Weapon archetypes: M011-M016, M020, M025-M026, M030
- Projectile traits: M021-M024
- Status families: M064-M073 (poison, burn, slow, fear, charm, confusion, freeze, bleed, bait, chained)
- Companion effects: M038-M039, M043-M044
- Spawn/hazard on hit and room-entry: M046-M047, M079
- Shop modifiers: M055, M057
- Map/room intel: M081
- Luck stat and proc curves: M085-M086
- Damage prevention: M089
- Economy baseline: drop-on-kill, drop-on-room-clear, drop-on-hit, drop-on-pickup (partial M048)

**Total implemented families: M001-M006, M011-M016, M020-M026, M030, M038-M039, M043-M044, M046-M047, M055, M057, M064-M073, M079, M081, M085-M086, M089**

Notable unimplemented families (highest remaining leverage):
- Projectile shape modifiers: M017/M018 (directional appenders — current next milestone), M019 (burst cadence)
- Projectile behavior expansions: M027, M028, M031, M033, M034
- Stat/trigger gaps: M003, M007, M008, M009
- Economy/shop gaps: M048-M054, M056, M058-M059
- Room/curse/luck gaps: M080, M082-M084, M087-M088
- Spawn chains: M045, M076-M078
- Special mechanics: M090-M100
