...
var custom_color := Color.LIME_GREEN
var health_multiplier := 1.0
var speed_multiplier := 1.0

# Spawn tier metadata — based on Isaac Mulligan (Basement/Cellar only, Chapter 1)
@export var spawn_tier_min: int = 1
@export var spawn_tier_max: int = 3   # Mulligans are an early-game enemy
@export var spawn_weight: int = 7
